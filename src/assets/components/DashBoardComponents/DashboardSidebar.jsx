            ...
            <aside className={`DashBoard-sideBar ${mobileMenuOpen ? 'mobile-open' : ''}`}>
                <div className="sideBar-Header">
                    ...
                    <div className="close-menu" onClick={toggleMobileMenu}>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M18 6L6 18" stroke="#0C4651" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M6 6L18 18" stroke="#0C4651" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                    </div>
                </div>
                <br />
                ...
                <div className="sidebar-footer">
                    <div className={"sideBar-user-Details"}>
                        ...
                        <div className={"userEmail"}> <p title={userDetails.email}>{userDetails.email}</p> </div>
                    </div>
                    <br />
